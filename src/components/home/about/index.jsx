        ...
        <div className='flex items-start justify-start flex-col-reverse lg:flex-row lg:justify-between gap-12 mt-20 md:mt-32'>
          ...
          <div className = " w-full flex flex-col justify-center items-center  text-white">
            <div className='profile-image-wrapper w-full max-w-md aspect-[3/4] rounded-xl bg-white overflow-hidden flex items-center justify-center'>
                <div className='profile-image text-black text-h2 w-[115%] aspect-[3/4]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi, minus ut facilis quia repudiandae repellendus unde praesentium, rem eos qui eum! Eius, inventore! Fugiat, saepe deleniti similique soluta totam aliquid?</div>
            </div>
          </div>
        </div>
