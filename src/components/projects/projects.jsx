...
const HomeProjects = () => {
  ...
  return (
    <section ref ={containerRef} className='section pt-[calc(var(--padding-nav)*5)] pb-[calc(var(--padding-nav)*4)] pl-nav pr-nav md:pt-[calc(var(--padding-nav)*5)] lg:pt-[calc(var(--padding-nav)*4)] min-h-screen w-full flex flex-col items-center justify-start relative z-10 bg-white'>
