...
const SerfPage = () => {
  ...
  return (
    ...
    >
        ...
        <section style={{backgroundColor : data.color}} className='relative section w-full aspect-square md:aspect-video flex flex-col items-center justify-center bg-white mt-20'>
            <Image
            src={data.banner.src}
